...
enum SAFE_RESULT safe_strcpy(char* source, char* destination, size_t length);

// result == a+b if no error has occurred
enum SAFE_RESULT safe_intadd(int a, int b, int* result);
// result == a-b if no error has occurred
enum SAFE_RESULT safe_intsub(int a, int b, int* result);
// result == a*b if no error occurred
enum SAFE_RESULT safe_intmul(int a, int b, int* result);
// result == a/b if no error occurred
enum SAFE_RESULT safe_intdiv(int a, int b, int* result);

// result == a+b if no error has occurred
enum SAFE_RESULT safe_uintadd(unsigned int a, unsigned int b, unsigned int* result);
// result == a-b if no error has occurred
enum SAFE_RESULT safe_uintsub(unsigned int a, unsigned int b, unsigned int* result);
// result == a*b if no error occurred
enum SAFE_RESULT safe_uintmul(unsigned int a, unsigned int b, unsigned int* result);
// result == a/b if no error occurred
enum SAFE_RESULT safe_uintdiv(unsigned int a, unsigned int b, unsigned int* result);
